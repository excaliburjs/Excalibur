...
[[Loadable|Loadables]] are different kinds of assets such as [image](/docs/imagesource), sounds, and generic resources.
...
If you are developing a game using Excalibur with Webpack, Parcel, or another bundler, these typically already come with dev servers for running your game. See [Excalibur project templates](/docs/installation#start-from-a-template) for templates you can start from that use these tools.
