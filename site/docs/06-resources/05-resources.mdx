...
{@apilink Loadable | `Loadables`} are different kinds of assets such as [image](/doc/imagesource), sounds, and generic resources.
...
## Generic {@apilink Resource | `Resources`}
...
- [[Gif]] resource supports loading Gif's as {@apilink Animation | `animation`}, {@apilink SpriteSheet | `spritesheets`}, or {@apilink Sprite | `sprites`}!
