...
The [[Matrix]] type encapsulates a 4x4 matrix that can be used in WebGL or for doing affine transformations on {@apilink Vector | `Vectors`} and other {@apilink Matrix | `Matrices`}.
