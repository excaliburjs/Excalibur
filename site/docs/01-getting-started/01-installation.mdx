...
If this is your first time using Excalibur, we recommend you start with our [Excalibird](/docs/excalibird-flappy-bird) tutorial where you can learn Excalibur in the browser.
...
Check out the [Excalibur CLI](/docs/quick-start) to spin up a template or sample quickly!
...
- [Sample Platformer](https://github.com/excaliburjs/sample-platformer)
...
- [as raw script files](#old-school-javascript) you can download
...
`node_modules/excalibur/build/esm/excalibur.min.js` path above in the HTML. We
