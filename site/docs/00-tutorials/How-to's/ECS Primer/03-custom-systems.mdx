  ...
  update(delta: number) {
    ...
    for (const entity of this.query.entities) {
      ...
      if (keyboardControl.keyboard.isHeld(Keys.ArrowUp)) {
        ...
        const index = keyboardControl.heldKey.indexOf('Up');
        if (index !== -1) keyboardControl.heldKey.splice(index, 1);
      }
      ...
      if (keyboardControl.keyboard.isHeld(Keys.ArrowDown)) {
        ...
        // clear held direction
        const index = keyboardControl.heldKey.indexOf('Down');
        if (index !== -1) keyboardControl.heldKey.splice(index, 1);
      }
      ...
      if (keyboardControl.keyboard.isHeld(Keys.ArrowLeft)) {
        ...
        // clear held direction
        const index = keyboardControl.heldKey.indexOf('Left');
        if (index !== -1) keyboardControl.heldKey.splice(index, 1);
      }
      ...
      if (keyboardControl.keyboard.isHeld(Keys.ArrowRight)) {
        ...
        // clear held direction
        const index = keyboardControl.heldKey.indexOf('Right');
        if (index !== -1) keyboardControl.heldKey.splice(index, 1);
      }
