...
A composite collider is a way of treating multiple pieces of geometry as one collider, this means there is a choice about how to resolve collisions.
...
Or per composite collider, this will override any default config
