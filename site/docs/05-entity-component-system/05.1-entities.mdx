...
[[Entity.kill]] flips the entity's `isActive` flag to `false` and queues it for removal —
...
from inside a collision handler or another entity's update loop. [[Entity.isKilled]] reports
