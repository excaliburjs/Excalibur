...
- They automatically [capture pointer events](/docs/pointers#handling-pointer-events-on-actors)
- They do not participate in collisions
- They appear above all "normal" actors in a [scene](/docs/scenes)
- Invoking [[ScreenElement.contains]] will check against [screen coordinates](/docs/screens#screen-coordinates) by default.
