...
Additionally it is also possible to use [collision groups](/docs/collisiongroups) to filter collisions between triggers and other actors because triggers are also actors.
