...
of `limitCameraBounds` it is limited to those constraints. 
...
add strategies to our scene. Occasionally you may need a bit more control over the strategy array. This can be done
