...
Engines also accept options like [[EngineOptions.antialiasing]], [[EngineOptions.snapToPixel]],
and [[EngineOptions.maxFps]] that control pixel rendering and frame-rate caps. See the
