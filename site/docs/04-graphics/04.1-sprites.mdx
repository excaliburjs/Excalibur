...
A sprite is a view into a [ImageSource](/docs/imagesource) and a projection into a final destination size.
...
Many times a sprite is the exact same view and size as the source [raw image](/docs/imagesource) so there is a quick static helper to do this
