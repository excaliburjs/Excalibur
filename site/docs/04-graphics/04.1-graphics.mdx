...
- `scale: Vector`
  ...
  - Gets or sets the scale of the graphic, this affects the width and height of the graphics
...
Circle creates a rastered circle graphic given a radius
...
Rectangle creates a rastered rectangle graphic given a width and height
...
The canvas is a special type of raster graphic that acts like a shim between direct CanvasRenderingContext2D drawing and the [ExcaliburGraphicsContext](/docs/graphics-context)
