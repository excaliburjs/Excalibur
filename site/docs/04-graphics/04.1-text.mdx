...
Text is a [raster](/docs/graphics#raster-graphics) [graphic](/docs/graphics) that can be used to draw text to the screen, all of the normal things that can be done with [rasters](/docs/graphics#raster-graphics) and [graphics](/docs/graphics) can be done with text.
...
[[Label|Labels]] are battery-included [[Actor|Actors]] with [[Text]] and fonts built in.
...
Sometimes you want to use a custom font based on your [spritesheet](/docs/spritesheets) of character glyphs
