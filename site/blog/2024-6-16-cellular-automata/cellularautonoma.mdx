...
This article is about Cellular Automata, which follows suit of my previous articles regarding other procedural generation strategies for game development.  
In my last article, we studied the [Wave Function Collapse](../2024-06-01-wave-function-collapse/wfc.md)Algorithm. 
Staying within that topical thread of procedural algorithms which can be leveraged in game development, let's turn our focus to Cellular Automata.
