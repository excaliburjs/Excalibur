...
var Point = (function (_super) {
    ...
    function Point(x, y, expectedX, expectedY) {
        ...
        _this.expectedX = expectedX;
        _this.expectedY = expectedY;
        return _this;
    }
    return Point;
}(ex.Actor));
...
var GridLine = (function (_super) {
    ...
    function GridLine(dir, pos, size) {
        var _this = _super.call(this, dir === "x" ? pos : 0, dir === "y" ? pos : 0, dir === "x" ? 1 : size, dir === "y" ? 1 : size, ex.Color.fromHex("#dedede")) || this;
        _this.anchor.setTo(0, 0);
        return _this;
    }
    return GridLine;
