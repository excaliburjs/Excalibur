...
export class Screen {
   ...
   *
   * World space is where {@apilink Entity | `entities`} in Excalibur live by default [[CoordPlane.World]]
   ...
   *
   * Screen space is where {@apilink ScreenElement | `screen elements`} and {@apilink Entity | `entities`} with [[CoordPlane.Screen]] live.
