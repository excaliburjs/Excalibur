...
export class PointerEvent extends GameEvent<any> {
   ...
   public pos: Vector;
   /**
    * @deprecated x       The `x` coordinate of the event (in world coordinates), now used to initiate `pos` Vector property
    * @deprecated y       The `y` coordinate of the event (in world coordinates), now used to initiate `pos` Vector property
    ...
    * @param pos          The Vector object of the event (in world coordinates)
    */
