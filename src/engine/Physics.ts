...
export class Physics {
   /**
    * Global acceleration that is applied to all vanilla actors that have an [[CollisionType.Active|active]] collision type.
    * Global acceleration wont effect [[Label|labels]], [[UIActor|ui actors]], or [[Trigger|triggers]] in Excalibur.
    * 
