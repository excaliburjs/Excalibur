...
export enum DisplayMode {
   ...
   * The displayed area outside the aspect ratio is not guaranteed to be on the screen, only the {@link Screen.contentArea}
   ...
   * This displayed area outside the aspect ratio is not guaranteed to be on the screen, only the {@link Screen.contentArea}
   * is guaranteed to be on screen.
   */
   ...
   * (letterbox) that would otherwise be present in {@link FitContainer}.
   *
   * **warning** This will clip some drawable area from the user because of the zoom,
   * use {@link Screen.contentArea} to know the safe to draw area.
   */
   ...
   * (letterbox) that would otherwise be present in {@link FitScreen}.
   *
   * **warning** This will clip some drawable area from the user because of the zoom,
   * use {@link Screen.contentArea} to know the safe to draw area.
   */
   ...
   * This is not the same as {@link Screen.enterFullscreen} but behaves in a similar way maintaining aspect ratio.
   *
   ...
   * change dynamically as the window is resized. This is not the same as {@link Screen.enterFullscreen}
   */
...
export interface ScreenOptions {
   ...
   * resolution will be the same as the viewport. Resolution will be overridden by {@link DisplayMode.FillContainer} and
   * {@link DisplayMode.FillScreen}.
   */
...
export class Screen {
  ...
  /**
   * Listen to screen events {@link ScreenEvents}
   */
   ...
   *
   * World space is where {@link Entity | `entities`} in Excalibur live by default {@link CoordPlane.World}
   * and extends infinitely out relative from the {@link Camera}.
   ...
   *
   * Screen space is where {@link ScreenElement | `screen elements`} and {@link Entity | `entities`} with {@link CoordPlane.Screen} live.
