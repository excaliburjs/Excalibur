...
import { isMoveByOptions, MoveBy, MoveByWithOptions } from './Action/MoveBy';
import type { MoveToOptions } from './Action/MoveTo';
import { isMoveToOptions, MoveTo, MoveToWithOptions } from './Action/MoveTo';
import type { RotateToOptions } from './Action/RotateTo';
import { RotateTo, RotateToWithOptions } from './Action/RotateTo';
import type { RotateByOptions } from './Action/RotateBy';
import { RotateBy, RotateByWithOptions } from './Action/RotateBy';
import type { ScaleToOptions } from './Action/ScaleTo';
import { isScaleToOptions, ScaleTo, ScaleToWithOptions } from './Action/ScaleTo';
import type { ScaleByOptions } from './Action/ScaleBy';
import { isScaleByOptions, ScaleBy, ScaleByWithOptions } from './Action/ScaleBy';
...
import { CurveTo } from './Action/CurveTo';
import type { CurveByOptions } from './Action/CurveBy';
import { CurveBy } from './Action/CurveBy';
