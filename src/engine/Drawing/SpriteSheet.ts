...
export class SpriteSheetImpl {
  ...
  constructor(
    ...
    if (this.image instanceof Texture && this.spWidth * this.columns > this.image.image.naturalWidth) {
      throw new Error('SpriteSheet specified is wider than image width');
    }
    if (this.image instanceof Texture && this.spHeight * this.rows > this.image.image.naturalHeight) {
