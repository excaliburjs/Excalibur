 ...
 * Excalibur comes built-in with a {@link ConsoleAppender} and {@link ScreenAppender}.
 * Derive from {@link Appender} to create your own logging appenders.
 */
export class Logger {
   ...
   * messages if equal to or above this level. Default: {@link LogLevel.Info}
   */
  ...
  /**
   * Adds a new {@link Appender} to the list of appenders to write to
   */
  ...
  /**
   * Writes a log message at the {@link LogLevel.Debug} level
  ...
  /**
   * Writes a log message once at the {@link LogLevel.Fatal} level, if it sees the same args again it wont log
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message at the {@link LogLevel.Info} level
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message once at the {@link LogLevel.Info} level, if it sees the same args again it wont log
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message at the {@link LogLevel.Warn} level
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message once at the {@link LogLevel.Warn} level, if it sees the same args again it won't log
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message at the {@link LogLevel.Error} level
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message once at the {@link LogLevel.Error} level, if it sees the same args again it won't log
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message at the {@link LogLevel.Fatal} level
   * @param args  Accepts any number of arguments
   */
  ...
  /**
   * Writes a log message once at the {@link LogLevel.Fatal} level, if it sees the same args again it won't log
   * @param args  Accepts any number of arguments
   */
...
export interface Appender {
  /**
   * Logs a message at the given {@link LogLevel}
