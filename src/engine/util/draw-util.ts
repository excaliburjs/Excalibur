 ...
 * @param cap The {@link LineCapStyle} (butt, round, or square)
 */
 ...
 * @param stroke The {@link Color} to stroke rectangle with
 * @param fill The {@link Color} to fill rectangle with
 */
