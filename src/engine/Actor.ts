...
/// <reference path="Traits/MovementModule.ts" />
/// <reference path="Traits/OffscreenCullingModule.ts" />
/// <reference path="Traits/CapturePointerModule.ts" />
/// <reference path="Traits/CollisionDetectionModule.ts" />
