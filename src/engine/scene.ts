...
/**
 * {@link Actor | `Actors`} are composed together into groupings called Scenes in
...
export class Scene<TActivationData = unknown> implements CanInitialize, CanActivate<TActivationData>, CanDeactivate, CanUpdate, CanDraw {
  ...
  /**
   * The {@link TileMap}s in the scene, if any
   */
  ...
  /**
   * This is called before the first update of the {@link Scene}. Initializes scene members like the camera. This method is meant to be
  ...
  /**
   * Gets whether or not the {@link Scene} has been initialized
   */
   ...
   * It is not recommended that internal excalibur methods be overridden, do so at your own risk.
   *
   * Internal _predraw handler for {@link onPreDraw} lifecycle event
   * @internal
   */
   ...
   * It is not recommended that internal excalibur methods be overridden, do so at your own risk.
   *
   * Internal _postdraw handler for {@link onPostDraw} lifecycle event
   * @internal
   */
  ...
  /**
   * Updates all the actors and timers in the scene. Called by the {@link Engine}.
  ...
  /**
   * Draws all the actors in the Scene. Called by the {@link Engine}.
  ...
  /**
   * Draws all the actors' debug information in the Scene. Called by the {@link Engine}.
   * @param ctx  The current rendering context
   */
  ...
  /**
   * Adds a {@link Timer} to the current {@link Scene}.
   * @param timer  The timer to add to the current {@link Scene}.
   */
  public add(timer: Timer): void;

  /**
   * Adds a {@link TileMap} to the {@link Scene}, once this is done the {@link TileMap} will be drawn and updated.
   */
  public add(tileMap: TileMap): void;

  /**
   * Adds a {@link Trigger} to the {@link Scene}, once this is done the {@link Trigger} will listen for interactions with other actors.
   * @param trigger
   */
  public add(trigger: Trigger): void;

  /**
   * Adds an actor to the scene, once this is done the {@link Actor} will be drawn and updated.
   * @param actor  The actor to add to the current scene
   */
  public add(actor: Actor): void;

  /**
   * Adds an {@link Entity} to the scene, once this is done the {@link Actor} will be drawn and updated.
   * @param entity The entity to add to the current scene
   */
  public add(entity: Entity): void;

  /**
   * Adds a {@link ScreenElement} to the scene.
  ...
  /**
   * Removes a {@link Timer} from it's current scene
  ...
  /**
   * Removes a {@link TileMap} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
  ...
  /**
   * Removes a {@link Trigger} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
  ...
  /**
   * Removes an {@link Actor} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
  ...
  /**
   * Removes an {@link Entity} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
  ...
  /**
   * Removes a {@link ScreenElement} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
  ...
  /**
   * Removes an {@link Entity} (Actor, TileMap, Trigger, etc) or {@link Timer} from it's current scene
   * and adds it to this scene.
   *
   * Useful if you want to have an object be present in only 1 scene at a time.
   * @param entity
  ...
  /**
   * Removes a {@link Timer} from the current scene, it will no longer be updated.
   * @param timer  The timer to remove to the current scene.
   */
  public remove(timer: Timer): void;

  /**
   * Removes a {@link TileMap} from the scene, it will no longer be drawn or updated.
  ...
  /**
   * Adds a {@link Timer} to the scene
  ...
  /**
   * Removes a {@link Timer} from the scene.
   * **Warning:** Can be dangerous, use {@link cancelTimer} instead
  ...
  /**
   * Cancels a {@link Timer}, removing it from the scene nicely
  ...
  /**
   * Tests whether a {@link Timer} is active in the scene
   */
