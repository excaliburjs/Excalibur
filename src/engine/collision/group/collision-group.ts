...
/**
 * CollisionGroups indicate like members that do not collide with each other. Use {@link CollisionGroupManager} to create {@link CollisionGroup}s
 *
 * For example:
 *
...
export class CollisionGroup {
  /**
   * The `All` {@link CollisionGroup} is a special group that collides with all other groups including itself,
  ...
  /**
   * STOP!!** It is preferred that {@link CollisionGroupManager.create} is used to create collision groups
