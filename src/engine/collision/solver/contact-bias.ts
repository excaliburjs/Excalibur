...
/**
 * Vertical First contact solve bias Used by the {@link ArcadeSolver} to sort contacts
 */
...
/**
 * Horizontal First contact solve bias Used by the {@link ArcadeSolver} to sort contacts
 */
...
/**
 * None value, {@link ArcadeSolver} sorts contacts using distance by default
 */
