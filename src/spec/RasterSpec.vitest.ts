...
describe('A Raster', () => {
  ...
  it('can be drawn', async () => {
    ...
    await expect(canvasElement).toEqualImage('/src/spec/images/GraphicsRasterSpec/raster.png');
  });
  ...
  it('can have the quality increased', async () => {
    ...
    sut.quality = 4;
    sut.draw(ctx, 25, 25);
    await expect(canvasElement).toEqualImage('/src/spec/images/GraphicsRasterSpec/raster-quality.png');
  });
