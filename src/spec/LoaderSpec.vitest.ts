    ...
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/zero.png'])
          .then(() => {
            done();
          });
      };
  ...
  it('can be drawn at 50', () =>
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        loader.onDraw(loader.canvas.ctx);
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/fifty.png'])
          .then(() => {
            done();
          });
      };
  ...
  it('can be drawn at 100', () =>
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        loader.onDraw(loader.canvas.ctx);
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/100.png'])
          .then(() => {
            done();
          });
      };
  ...
  it('does not show progress when the play button is shown', () =>
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        loader.onDraw(loader.canvas.ctx);
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/playbuttonshown-noprogressbar.png'])
          .then(() => {
            done();
          });
      };
  ...
  it('can have the logo position customized', () =>
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        loader.onDraw(loader.canvas.ctx);
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/logo-position.png'])
          .then(() => {
            done();
          });
      };
  ...
  it('can have the loader customized', () =>
    new Promise<void>((done) => {
      ...
      (loader as any)._image.onload = () => {
        ...
        loader.onDraw(loader.canvas.ctx);
        expect(loader.canvas.ctx.canvas)
          .toHaveLoadedImages(['/src/spec/images/LoaderSpec/loader-position-color.png'])
          .then(() => {
            done();
          });
      };
